...
from golem.ethereum.password import get_saved_password, PASSWORD_LENGH
...
class EthereumPasswordTest(TempDirFixture):
    ...
    def test_write_and_read(self):
        ...
        assert len(password1) == PASSWORD_LENGH
    ...
    def test_passwords_are_different(self):
        ...
        assert len(pass1) == PASSWORD_LENGH
        assert len(pass2) == PASSWORD_LENGH
        assert pass1 != pass2
